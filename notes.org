...
* Save/Load
** TODO Implement basic functionality to serialize/deserialize to/from JSON
*** TODO Add a writeup about this, since it's non-trivial
*** TODO Start documentation for JSON format versioning
** TODO Move all global state to a single place
** TODO Implement functionality to stash/restore full global state
** TODO Implement "Save"
